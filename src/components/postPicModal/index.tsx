...
const PostPicModal = ({ visible, setVisible }: PostPicModalProps) => { 
  ...
  return (
    <div className={`modal fixed w-full h-full top-0 left-0 flex items-center justify-center ${visible? 'visible' : 'invisible'}`}>
      ...
      <div className="modal-container bg-white w-full md:max-h-96 h-1/2 md:max-w-2xl mx-auto rounded shadow-lg z-50 overflow-y-auto">
        ...
        <div className="modal-content h-full py-4 text-left px-6 flex flex-col justify-between">
          <div className="flex justify-between items-center pb-3 ml-auto cursor-pointer" role="main" onClick={(e) => setVisible(false)} onKeyDown={()=>null}>
          ...
          <div className="flex justify-end pt-2">
            <button className="px-4 bg-blue-medium p-3 rounded-lg text-white hover:bg-blue-hover mr-2" type="button">Post</button>
          </div>
